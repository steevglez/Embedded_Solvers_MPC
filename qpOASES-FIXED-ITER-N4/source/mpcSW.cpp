...
void mpcSW(elem x[N_SYS], elem yref[P_SYS], elem xmin[N_SYS], elem xmax[N_SYS], elem umin[M_SYS], elem umax[M_SYS], elem A[N_SYS][N_SYS], elem B[N_SYS], elem Acal[N_SYS*N_QP][N_SYS], elem AcalOmgOcal[N_SYS][N_QP], elem H[N_QP *N_QP], elem Mx[N_SYS*N_QP*2+2*N_QP *N_QP], elem L_last[N_SYS+P_SYS], elem u[N_SYS], qpOASES::QProblem *example, int num_iter, int *started, double output_array[], tictoc *SOLVERTimer, int sample){
