...
int main(int argc, char *argv[])
{
    ...
    for (int sample=0; sample<nSamples; sample++){
        ...
        MPCTimer.tic();
        mpcSW(x_real, yref, xmin, xmax, umin, umax, A, B, Acal, AcalOmgOcal, H, Mx, L_invLast, iterPDIP, iterLS, tol, u, &example, NUM_ITER, &started, output_array, &SOLVERTimer, sample);
        MPCTimer.toc();
