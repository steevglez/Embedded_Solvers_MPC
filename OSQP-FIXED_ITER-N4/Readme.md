...
Se incluye un script para la compilacion de OSQP y los codigos que implementan MPC, que ademas contempla la ejecucion de un ejemplo con N=4. Para ejecutar este script se deben otorgar permisos de ejecucion por medio de:
